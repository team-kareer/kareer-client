export { default as OnboardingStepHeader } from './ui/onboarding-step-headear/onboarding-step-header';
export { type OnboardingStepData } from './ui/onboarding-step-headear/onboarding-step-header';
